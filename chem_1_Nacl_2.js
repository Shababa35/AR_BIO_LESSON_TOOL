...
if (!THREE) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const start = async () => {
            ...
            loader.load('./applications/assets/models/Nacl_writing/nacl.gltf', (gltf) => {
                // Adjusting the scale (increase size)
                gltf.scene.scale.set(0.1, 0.1, 0.1); // Set a larger size for the robot
            ...
            renderer.setAnimationLoop(() => {
                ...
                if (loadedModel) {
                    loadedModel.rotation.y += 0; // Adjust rotation speed here
                }
